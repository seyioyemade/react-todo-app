...
- React Todo App is a web application that allows users to plan their daily schedule.
...
- git clone https://github.com/seyioyemade/react-todo-app.git
- cd react-todo-app
- npm start
...
Feel free to check the [issues page](https://github.com/seyioyemade/react-todo-app/issues).
